import{_ as r}from"./nuxt-link.daa3e325.js";import{d as a,o as l,b as c,j as e,h as i,t as s,e as d,w as _,f as u,ah as m}from"./entry.b43c92c6.js";import"./entry.4b682d46.js";const x={class:"surface-0 flex align-items-center justify-content-center min-h-screen min-w-screen overflow-hidden"},g={class:"grid justify-content-center p-2 lg:p-0",style:{"min-width":"80%"}},f={class:"col-12 mt-5 xl:mt-0 text-center"},h=["src"],p={class:"col-12 xl:col-6",style:{"border-radius":"56px",padding:"0.3rem",background:`linear-gradient(\r
            180deg,\r
